		...
		(function(a, b) {
			...
			J(
				d,
				{
					splice: function(a, b) {
						for (
							var c, d = M.ToObject(this), e = [], f = M.ToUint32(d.length), g = M.ToInteger(a), i = 0 > g ? s(f + g, 0) : t(g, f), j = t(s(M.ToInteger(b), 0), f - i), k = 0;
							j > k;
					...
					Date.prototype,
					{
						toUTCString: function() {
							...
							var a = Va(this),
								...
								g = Ya(this)
							return (
								$a[a] + ', ' + (10 > b ? '0' + b : b) + ' ' + _a[c] + ' ' + d + ' ' + (10 > e ? '0' + e : e) + ':' + (10 > f ? '0' + f : f) + ':' + (10 > g ? '0' + g : g) + ' GMT'
							)
						}
					},
					Ka || Na
			...
			var lb =
					k.toFixed && ('0.000' !== (8e-5).toFixed(3) || '1' !== (0.9).toFixed(0) || '1.25' !== (1.255).toFixed(2) || '1000000000000000128' !== (0xde0b6b3a7640080).toFixed(0)),
				mb = {
					base: 1e7,
					size: 6,
					data: [0, 0, 0, 0, 0, 0],
			...
			J(
				i,
				{
					lastIndexOf: function(a) {
						if ('undefined' == typeof this || null === this) throw new TypeError("can't convert " + this + ' to object')
						for (
							var b = h(this), c = h(a), d = arguments.length > 1 ? j(arguments[1]) : NaN, e = L(d) ? 1 / 0 : M.ToInteger(d), f = t(s(e, 0), b.length), g = c.length, i = f + g;
							i > 0;
